...
#history_effnet = model_train(model_name = EfficientNetB0(weights='imagenet', include_top=False, input_shape=(224,224,3)), save_name = "effnet_flair", image_size = 224, dropout=0.7, optimizer=tf.keras.optimizers.Adam(learning_rate=0.0001), dense_0_units=48, dense_1_units=112, batch_size=16)
history_densenet_weights = model_train(model_name = tf.keras.applications.densenet.DenseNet121(include_top=False, weights='imagenet', input_shape=(224,224,3), classes=2), save_name = "densenet_flair", image_size = 224, dropout=0.3, optimizer=tf.keras.optimizers.SGD(learning_rate=0.1), dense_0_units=48, dense_1_units=16, batch_size=32)
