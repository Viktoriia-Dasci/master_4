...
pretrained_model = load_model('/home/viktoriia.trokhova/model_weights/inception_t2.h5', custom_objects={'f1_score': f1_score, 'focal_loss': focal_loss})
...
def lime_coef(img_class, img_msk_class):
    img_dir = "/home/viktoriia.trokhova/T2_new_MRI_slices/test/" + img_class + "_t2"
