...
history_vit = model_train(model_name = tfa.vision.models.vit.ViTModel(include_top=False, weights='imagenet', input_shape=(224,224,3), classes=2))

plot_acc_loss(history_vit)

history_deit = model_train(model_name = tfa.vision.models.deit.DeiT(include_top=False, pretrained=True, input_shape=(224,224,3), classes=2))

plot_acc_loss(history_deit)

history_Regnety = model_train(model_name = tfa.vision.models.deit.Regnety(include_top=False, pretrained=True, input_shape=(224,224,3), classes=2))

plot_acc_loss(history_Regnety)

history_NFNet = model_train(model_name = tfa.vision.models.nfnet.NFNet(include_top=False, pretrained=True, input_shape=(224,224,3), classes=2))
