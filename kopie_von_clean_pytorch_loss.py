...
best_val_auc = train_with_early_stopping(model, optimizer = optim.SGD(model.parameters(), lr=0.004), patience=10, PATH= '/home/viktoriia.trokhova/model_weights/model_resnet.pt')
